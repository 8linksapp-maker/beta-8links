  ...
  const apis = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: "article-54nano",
          label: "Gerar Artigo (gpt-5.4-nano)",
          icon: Globe,
          desc: "Pipeline completo com gpt-5.4-nano. Modelo mais novo.",
          needsUrl: true,
          call: () => callApi("article-54nano", () => fetch("/api/admin/test-article", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ keyword: url, model: "gpt-5.4-nano", backlink: clientSite ? { url: clientSite, anchor: blAnchor, clientDescription: clientContext } : undefined, siteContext: networkContext || undefined }) })),
        },
        {
          id: "plan-content",
